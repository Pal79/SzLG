...
![nevezetes szögfüggvények 30, 60](../images/matematika-nevezetes-szogfuggvenyek-001.png)

- A szögfüggvényeinek  definíciója szerint: $tg45^{\circ} = ctg^{\circ} = 1$ és $sin45^{\circ} = cos45^{\circ} = \frac{1}{\sqrt{2}}$.
- Ez utóbbi esetben a számlálót és a nevezőt $\sqrt{2}$​-vel szorova kapjuk: $sin45^{\circ} = cos45^{\circ} = \frac{\sqrt{2}}{2}$
...
![nevezetes szögfüggvények 30, 90](../images/matematika-nevezetes-szogfuggvenyek-002.png)
